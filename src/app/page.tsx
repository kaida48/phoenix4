    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="container mx-auto px-6 py-20 flex flex-col items-center">
        ...
        <p className="text-xl text-gray-300 text-center max-w-2xl mb-12">
          Welcome to the Sunrise Isles character submission system. Create your
          character and become part of the story.
        </p>
        {status === "authenticated" ? (
          <Link
            href="/characters"
            className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg text-center"
          >
            Go to Dashboard
          </Link>
        ) : (
